...
type Cached = ICacheable & GoogleToken;

export class Cache {
	public static readonly tokenCacheKey = "youtube:token";
	public static readonly verifierCacheKey = "youtube:verifier";
	...
	public async getOrCreateToken(code?: string): Promise<Cached> {
		...
		if (!GoogleTokenUtil.isEmptyAccessToken(newCacheItem)) this.setCache(Cache.tokenCacheKey, newCacheItem);
