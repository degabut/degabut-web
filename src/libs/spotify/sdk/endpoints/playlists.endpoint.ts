...
export class PlaylistsEndpoint extends BaseEndpoint {
	public getPlaylist<AdditionalTypes extends QueryAdditionalTypes | undefined = undefined>(
		...
		return this.getRequest<Playlist<AdditionalTypes extends undefined ? Track : TrackItem>>(
	...
	public getPlaylistItems<AdditionalTypes extends QueryAdditionalTypes | undefined = undefined>(
		...
		return this.getRequest<Page<PlaylistedTrack<AdditionalTypes extends undefined ? Track : TrackItem>>>(
