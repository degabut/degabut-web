...
export const ItemListIcon: Component<Props> = (props) => {
	const src = () => (typeof props.icon === "string" ? props.icon : props.icon.at(0));
...
export const ItemListIconBig: Component<BigProps> = (props) => {
	const src = () => (typeof props.icon === "string" ? props.icon : props.icon.at(0));
